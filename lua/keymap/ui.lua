...
local mappings = {
	builtins = {
		...
		["n|<leader>["] = map_cmd("<Cmd>wincmd h<CR>"):with_silent():with_noremap():with_desc("window: Focus left"),
		["n|<leader>]"] = map_cmd("<Cmd>wincmd l<CR>"):with_silent():with_noremap():with_desc("window: Focus right"),
		-- Builtins: Tabpage
